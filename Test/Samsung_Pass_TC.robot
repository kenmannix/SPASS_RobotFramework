...
Test Case 8
    ...
    Sleep    2s
    Input Text    //*[@id="spassAppsFilterForm"]/div/div[1]/div[1]/div/div/div/div/input    1.2.3.4.5
    Sleep    2s
    Click Button    //*[@id="spassAppsFilterForm"]/div/div[2]/button[2]  
    Sleep    2s  
    Wait Until Page Contains    No Results Found    
    Sleep    2s
    Click Button    id=spassAppsFilterClearBtn
    Sleep    3s
    Close Browser
...
Test Case 9
    ...
    Wait Until Page Contains    Clear All
    Sleep    2s
    Input Text    //*[@id="filterForm"]/div/div[1]/div/div/div/div/div/input    1.2.3.4.5
    Sleep    2s
    Click Button    //*[@id="filterForm"]/div/div[2]/button[2]  
    Sleep    2s  
    Wait Until Page Contains    No Results Found    
    Sleep    2s
    Click Button    //*[@id="resetFilterBtn"]
    Sleep    3s
    Close Browser
    Log To Console    Test Execution Completed with no errors.      
